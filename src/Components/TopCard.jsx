  ...
  return (
    <div className="w-full laptop:w-[237.32px] desktop:w-full h-[120px] rounded-xl bg-white drop-shadow-card px-[27px] py-[18.5px]">
      ...
      <div className="flex flex-col mt-[7.36px] h-[44px]">
        <h6 className="text-[11px] font-secondary"> {data.title}</h6>
        <div className="flex items-center justify-between ">
          <h1 className="font-bold text-lg xl:text-[21px] font-sans">{data.value}</h1>

          <div className="flex justify-center items-center py-[4px] px-[8px] bg-[#E9F9EB] rounded-[34px] w-[47px] h-[24px]">
            <p className="text-[#3CC952] center text-[10px] font-semibold leading-[16px] reaming-[0.5px] uppercase font-primary">
              {data.change}
            </p>
          </div>
        </div>
